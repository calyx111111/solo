...
import com.huawei.agenticmode.actions.ToggleProjectPanelAction
import com.huawei.agenticmode.vcoder.agent.AgentProcessManager
import com.huawei.agenticmode.vcoder.webview.WebViewPanel
...
class SoloModePanel(
    ...
    private val agentManager: com.huawei.agenticmode.vcoder.agent.AgentProcessManager?
) : JPanel(BorderLayout()) {

    companion object {
        private val webViewCache = mutableMapOf<Project, com.huawei.agenticmode.vcoder.webview.WebViewPanel>()
        ...
        private fun getOrCreateWebView(project: Project, agentManager: com.huawei.agenticmode.vcoder.agent.AgentProcessManager): com.huawei.agenticmode.vcoder.webview.WebViewPanel =
            webViewCache.getOrPut(project) {
                com.huawei.agenticmode.vcoder.webview.WebViewPanel(
                    project,
                    null,
                    agentManager
                )
    ...
    private val webViewPanel: com.huawei.agenticmode.vcoder.webview.WebViewPanel
...
//        }
    ...
    fun getWebViewPanel(): com.huawei.agenticmode.vcoder.webview.WebViewPanel? = webViewPanel
}
